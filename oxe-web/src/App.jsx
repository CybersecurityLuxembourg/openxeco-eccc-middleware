...
class App extends React.Component {
	...
	componentDidMount() {
		document.getElementById("favicon").href = getOpenxecoEndpoint() + "public/get_public_image/favicon.ico";
	}
	...
	logout() {
		postRequest.call(this, getOpenxecoEndpoint() + "account/logout", null, () => {
			this.setState({
				user: null,
				logged: false,
			});
