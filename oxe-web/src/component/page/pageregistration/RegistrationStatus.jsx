	...
	constructor(props) {
		...
		this.state = {
			requiredTaxonomies: {
				...
				assurance_audit_certification: "Assurance, Audit, and Certification",
				cryptology: "Cryptology (Cryptography and Cryptanalysis)",
				data_security_and_privacy: "Data Security and Privacy",
				education_and_training: "Education and Training",
				human_aspects: "Human aspects",
				identity_and_access_management: "Identity Management",
				op_incident_handling_forensics: "Incident Handling and Digital Forensics",
				legal_aspects: "Legal aspects",
				network_and_distributed_systems: "Network and Distributed Systems",
				security_management_and_governan: "Security Management and Governance",
				security_measurements: "Security Measurements",
				soft_and_hard_sec_engineering: "Software and Hardware Security Engineering",
				steganography_steganalysis_and_w: "Steganography, Steganalysis and Watermarking",
				theoretical_foundations: "Theoretical Foundations",
				trust_management_accountability: "Trust Management and Accountability",
				sectors: "Sectors",
